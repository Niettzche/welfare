        ...
        <div className="w-full border-b-4 border-slate-900 bg-white relative overflow-hidden group">
            ...
            <div className="max-w-7xl mx-auto px-6 py-16 md:py-24 relative z-10">
                ...
                <h1 className="text-6xl md:text-8xl lg:text-9xl font-black text-slate-900 leading-[0.9] tracking-tighter mb-8 animate-reveal-up">
                    PARENTING<br />
                    <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-purple-600 stroke-black text-stroke-2 animate-elegant-float inline-block">ACADEMY</span>
                </h1>
        ...
        <div className="max-w-7xl mx-auto px-6 py-12 relative">
            ...
            {error ? (
                <div className="text-center py-20 animate-fade-in-up">
                    ...
                    <button onClick={() => window.location.reload()} className="mt-4 px-6 py-2 bg-slate-900 text-white rounded-lg font-bold hover:scale-105 transition-transform">Retry</button>
                </div>
            ) : courses.length === 0 ? (
